                    ...
                    <tr> 
                        <xsl:choose>
                            <xsl:when test="precio &lt; 25">  
                                <td bgcolor="#1BFF00"><xsl:value-of select="isbn"/></td>
                                <td bgcolor="#1BFF00"><xsl:value-of select="titulo"/></td>
                                <td bgcolor="#1BFF00"><xsl:value-of select="autor"/></td>
                                <td bgcolor="#1BFF00"><xsl:value-of select="precio"/></td>
                            </xsl:when>
                            <xsl:when test="precio &gt; 25">  
